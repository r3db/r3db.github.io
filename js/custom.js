  ...
  /* ----------------------------------------------------------- */
    ...
    $("#client-carousel").owlCarousel({
      ...
      $("#map").gmap3({
        ...
        marker:{
          values:[
            {address:"Av. 25 de Abril, 184 Cascais Portugal", data:" Actnow Headquarter ! ! ", 
/*
             options:{icon: "http://themewinter.com/html/dart/dart-marker.png"}}
 */
             options:{icon: "images/logo8.png"}}
          ],
          options:{
            draggable: false
          },
      ...
      $(".prodwin").colorbox({iframe:true, width:"75%", height:"75%"});
});
